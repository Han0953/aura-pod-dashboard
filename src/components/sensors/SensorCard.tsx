...
export const SensorCard: React.FC<SensorCardProps> = ({
  ...
  return (
    <div className="flex flex-col justify-between h-full bg-aura-surface border border-aura-border hover:border-aura-border-hover p-5 rounded-2xl transition-all duration-200 shadow-sm hover:shadow-md group">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="flex flex-col min-w-0">
            <span className="font-heading font-semibold text-aura-text-primary text-sm truncate">
              {title}
            </span>
            <span className="text-[11px] text-aura-text-secondary font-mono uppercase tracking-wider truncate">
              {hardwareSensor}
            </span>
          </div>
        </div>
      ...
      <div className="flex items-baseline justify-between mt-auto pt-4">
        ...
        {/* Mini SVG Sparkline or Empty Spacer for Visual Parity */}
        {sparkline !== "none" ? (
          !offline ? (
            <div className="w-24 h-9 overflow-visible transition-opacity shrink-0">
              <svg
            ...
            <div className="w-24 h-9 flex items-center justify-center opacity-35 shrink-0">
